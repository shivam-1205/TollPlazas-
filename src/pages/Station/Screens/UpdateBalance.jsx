...
import { updateWallet } from '../../../store/actions/customerAction';

export default function UpdateBalance({ setShow, data }) {
    ...
    const handleSubmit = () => {
        ...
        dispatch(updateWallet(updatedData))
        setLoading(false);
        setShow(false);
    };
        ...
        <div className="fixed inset-0 flex justify-center items-center z-50 bg-black bg-opacity-50 overflow-auto font-Poppins">
            <div className="w-full max-w-lg bg-white rounded-lg shadow-lg p-6 relative">
                <div className="flex items-center justify-between pb-4 border-b border-gray-300">
                    <h3 className="text-gray-800 text-xl font-semibold">Update Balance</h3>
                    <svg
                ...
                <div className="space-y-6 mt-4">
                    <div>
                        <label htmlFor="name" className="block text-lg font-semibold text-gray-700">Balance Amount</label>
                        <input
                            type="text"
                            id="balance"
                            value={balance}
